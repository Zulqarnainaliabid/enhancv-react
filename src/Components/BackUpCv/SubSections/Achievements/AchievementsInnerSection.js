      ...
      <div>
        ...
        >
          <div style={{ position: "relative", display: "flex" }}>
            {props.item.toggleSwitch[0].selected && <div>{Icon}</div>}
            <div style={{ width: "100%" }} className="d-flex flex-column ms-2">
              <TextareaAutosize className="InputFieldBachUpCv" placeholder="What are you most proud of?" draggable="false" value={props.item.title} />
