    ...
    <div>
      <div>
        ...
        >
          <div style={{ position: "relative", display: "flex" }}>
            <div style={{ width: "100%" }} className="d-flex justify-content-between">
              <div style={{ width: "80px" }}>
                <TextareaAutosize className="InputFieldBachUpCv" placeHolder="Language" draggable="false" value={props.list[props.index].value.language} />
              </div>
          ...
          {props.list[props.index].toggleSwitch[1].selected && <Slider min={1} max={5} tooltip={false} />}
