        ...
        <div className="outerWrapperBox BorderRadius d-flex flex-column flex-wrap">
          <div className="d-flex">
            ...
            {props.list[props.index].toggleSwitch[0].selected && (
              <div className="d-flex align-items-center">
                <div className=" text-center d-flex flex-column ps-3" style={{ borderLeft: "1px solid ", gap: "5px" }}>
                  <TextareaAutosize className="InputFieldBachUpCv" placeHolder={"GPA"} draggable="false" value={props.list[props.index].value.gpa} />
                  <div className="d-flex justify-content-center" style={{ gap: "5px" }}>
                    <TextareaAutosize className="InputFieldBachUpCv" placeHolder={"4.0"} draggable="false" value={props.list[props.index].value.gpaTotal} />

                    <p>/</p>
                    <TextareaAutosize className="InputFieldBachUpCv" placeHolder={"4.1"} draggable="false" value={props.list[props.index].value.gpaObtain} />
                  </div>
                </div>
              </div>
            )}
