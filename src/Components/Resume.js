...
export default function Resume(props) {
  ...
  const reactToPrintTrigger = React.useCallback(() => {
    return (
      <div className="d-flex align-items-center DownloadButton FontWeight CommonCssClassCursorPointer fontSize14" style={{ gap: "6px" }} onClick={() => {}}>
      ...
      <div className="pb-5">
        {state && (
          ...
          >
            ...
            <div className="d-flex align-items-center FontWeight RearrangeButtons CommonCssClassCursorPointer" style={{ gap: "6px" }}>
              <HiTemplate style={{ fontSize: "17px" }} />
              <p onClick={() => setState((state) => !state)}>Rearrange sessions</p>
            </div>
            <div
        ...
        <div>
          <div>
            <SwitchTransition mode="out-in">
              ...
              >
                <div>
                  <div className="btnRusme">{state ? Resume : <DragAndDropComponent setState={setState} />}</div>
                </div>
              </CSSTransition>
            </SwitchTransition>
          </div>
