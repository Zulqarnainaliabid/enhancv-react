...
export default function AwardsOuterSection (props) {
  ...
  useEffect (() => {
    let value = localStorage.getItem ('HeadingValueAwards');
    value = JSON.parse (value);
  ...
  useEffect (
    () => {
      if (contextData.BackGroundHighLitter !== 'Awards') {
        setHighLighter (false);
        handleInnerHight ();
      }
    },
    ...
    <div>
      <div
        ...
        onClick={e => {
          ...
          contextData.HandleUpdateBackGroundHighLitter ('Awards');
        }}
      >
        <div
              ...
              <div className="outerWrapperHeaderIcons">
                <Delete
                  onClick={() => {
                    ...
                    contextData.HandleRemoveElement ('AwardsOuterSection');
                  }}
