...
import ProjectsInnerSection from './ProjectsInnerSection';
...
export default function ProjectsOuterSection (props) {
  ...
  function HandlerAddItemInArray () {
    setHighLighter (false);
      ...
      array.push ({
        selected: false,
        toggleSwitch: [
          {name: 'Show Project Name', selected: true},
          {name: 'Show Description', selected: true},
          {name: 'Show Bullets', selected: true},
          {name: 'Show Location', selected: true},
          {name: 'Show Period', selected: true},
  ...
  useEffect (() => {
    let value = localStorage.getItem ('HeadingValueProjects');
    value = JSON.parse (value);
  ...
  useEffect (
    () => {
      if (contextData.BackGroundHighLitter !== 'Projects') {
        setHighLighter (false);
        handleInnerHight ();
      }
    },
    ...
    <div>
      <div
        ...
        onClick={e => {
          ...
          contextData.HandleUpdateBackGroundHighLitter ('Projects');
        }}
      >
        <div
