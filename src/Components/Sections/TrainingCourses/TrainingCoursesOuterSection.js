...
export default function TrainingOuterSection (props) {
  ...
  function GetItemFindMeOnline () {
    let value = localStorage.getItem ('TrainingCourses');
  ...
  function HandlerAddItemInArray () {
    setHighLighter (false);
      ...
      setState ([...temp]);
      localStorage.setItem ('TrainingCourses', JSON.stringify (array));
  }
              ...
              <div className="outerWrapperHeaderIcons">
                <Delete
                  onClick={() => {
                    ...
                    contextData.HandleRemoveElement ('Training');
                    localStorage.removeItem("TrainingCourses")
                  }}
