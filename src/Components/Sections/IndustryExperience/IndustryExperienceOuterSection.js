...
export default function IndustryExperienceOuterSection (props) {
  ...
  function GetItemFindMeOnline () {
    let value = localStorage.getItem ('IndustryExperience');
  ...
  useEffect (() => {
    let value = localStorage.getItem ('HeadingValueIndustryExperience');
    value = JSON.parse (value);
  ...
  useEffect (
    () => {
      if (contextData.BackGroundHighLitter !== 'IndustryExperience') {
        setHighLighter (false);
        handleInnerHight ();
      }
    },
    ...
    <div>
      <div
        ...
        onClick={e => {
          ...
          contextData.HandleUpdateBackGroundHighLitter ('IndustryExperience');
        }}
      >
        <div
